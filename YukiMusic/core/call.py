...
import config
from YukiMusic import LOGGER, YouTube, yuki
...
from YukiMusic.utils.exceptions import AssistantErr
from YukiMusic.utils.formatters import check_duration, seconds_to_min, speed_converter
from YukiMusic.utils.rich_stream import send_now_playing_rich
from YukiMusic.utils.stream.autoclear import auto_clean
from YukiMusic.utils.stream.autoplay import discard_prefetch, try_autoplay
from YukiMusic.utils.stream.history import record_played
from YukiMusic.utils.thumbnails import get_thumb
        ...
        try:
            ...
            if "live_" in queued:
                ...
                run = await send_now_playing_rich(
                    ...
                    img,
                    _["stream_1"].format(
                        f"https://t.me/{yuki.username}?start=info_{videoid}",
                        title[:23],
                        check[0]["dur"],
                        user,
                    ),
                ...
                mystic = await yuki.send_message(original_chat_id, _["call_7"])
                try:
