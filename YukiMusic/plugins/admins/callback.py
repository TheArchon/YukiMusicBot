...
from YukiMusic.misc import SUDOERS, db
...
from YukiMusic.utils.rich_stream import (
...
@yuki.on_callback_query(filters.regex("ADMIN") & ~BANNED_USERS)
@languageCB
...
@yuki.on_callback_query(filters.regex("nowplaying_queue") & ~BANNED_USERS)
