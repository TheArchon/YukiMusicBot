...
from YukiMusic.platforms.Youtube import is_external_path
from YukiMusic.utils.decorators.language import language, languageCB
from YukiMusic.utils.formatters import time_to_seconds
from YukiMusic.utils.rich_stream import caption_blocks, deliver_rich, edit_rich
...
@yuki.on_message(filters.command(["song"]) & ~BANNED_USERS)
@language
...
@yuki.on_callback_query(filters.regex(r"^SONG ") & ~BANNED_USERS)
@languageCB
